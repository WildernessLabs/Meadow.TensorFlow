...
The **Meadow.RTLiteForMicrocontrollers** library is included in the **Meadow.Foundation.RTLiteForMicrocontrollers** nuget package and is designed for the [Wilderness Labs](https://www.wildernesslabs.co) Meadow .NET IoT platform.
